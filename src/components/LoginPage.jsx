...
export const LoginPage = () => {
  ...
  const errorMessages = {
    ...
    password: "Please enter yout password",
  };
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6 " method="POST">
              ...
              <input
                ...
                className=" pr-1 pl-1 border-solid border-2 md:text-2xl font-bold text-gray-900 dark:text-white border-gray-300 bg-gray-50 rounded"
                type="button"
                value="Sign in"
              />
