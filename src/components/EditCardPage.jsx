...
useEffect(()=>{
  ...
  return (
    <form className=" bg-[url('/edit-bg.png')] bg-no-repeat bg-cover  mt-2 mx-auto  flex flex-col items-center border-solid border-2 w-1/2 pb-10 pt-10 rounded-3xl">
      ...
      <label
          htmlFor="card-image"
          className="block mb-2 text-sm font-medium text-white text-center dark:text-white"
        >
          Card Name
        </label>
        <input
      ...
      <div className="mb-6">
        <label
          htmlFor="card-image"
          className="block mb-2 text-sm text-center font-medium text-white dark:text-white"
        >
          Card Image Url
        </label>
        <input
      ...
      <div>
        <label
          htmlFor="small-input"
          className="block mb-2 text-sm  font-medium text-center text-white dark:text-white"
        >
          Card Attribute
        </label>
        <input
